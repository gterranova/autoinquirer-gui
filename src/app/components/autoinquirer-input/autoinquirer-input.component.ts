...
@Component({
  selector: 'app-autoinquirer-input',
  templateUrl: './autoinquirer-input.component.html',
  styleUrls: ['./autoinquirer-input.component.scss']
})
export class AutoinquirerInputComponent implements PromptComponent, OnInit {
  status: IState;
  prompt: IPrompt;
  inputForm: FormGroup;
