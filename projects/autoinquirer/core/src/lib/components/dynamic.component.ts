import { Component, OnInit, ViewChild, ComponentFactoryResolver, Input, OnDestroy, AfterViewInit, ChangeDetectorRef, ChangeDetectionStrategy, Inject } from '@angular/core';
import { Location } from '@angular/common';
import { Directive, ViewContainerRef } from '@angular/core';
import { ActivatedRoute, NavigationStart, Router } from '@angular/router';

import { ComponentType } from '@angular/cdk/portal';
import { DynamicComponentConfig, IServerResponse, PromptComponent, PromptCallbackType, FormlyService } from '@autoinquirer/shared';
...
export class DynamicContainer implements OnInit, OnDestroy {
  ...
  constructor(private route: ActivatedRoute,
    ...
    @Inject(FormlyService) private promptService: FormlyService,
